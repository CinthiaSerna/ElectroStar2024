                ...
                <div className='row'>
                    <div className='col-md-6'>
                        <form action='' onSubmit={handleSubmit}>
                            <div className='mb-3'>
                                <label htmlFor='documento'><strong className='titulo1'>Documento</strong></label>
                            ...
                            <div className='mb-3'>
                                <label htmlFor='nombre'><strong className='titulo1'>Nombre</strong></label>
                            ...
                            <div className='mb-3'>
                                <label htmlFor='apellido1'><strong className='titulo1'>Primer Apellido</strong></label>
                            ...
                            <div className='mb-3'>
                                <label htmlFor='apellido2'><strong className='titulo1'>Segundo Apellido</strong></label>
                    ...
                    <div className='col-md-6'>
                        <form action='' onSubmit={handleSubmit}>
                            <div className='mb-3'>
                                <label htmlFor='correo'><strong className='titulo1'>Correo</strong></label>
                            ...
                            <div className='mb-3'>
                                <label htmlFor='confirmCorreo'><strong className='titulo1'>Confirmar Correo</strong></label>
                            ...
                            <div className='mb-3'>
                                <label htmlFor='confirmPassword'><strong className='titulo1'>Contraseña</strong></label>
